...
class ReversePresenterTest {
    private lateinit var presenter : ReversePresenter
    ...
    @Test
    fun veryLongStrings(){
        assertEquals(presenter.reverse("moooooooooooooooooooooo5678lreeeeeeeddddddd","5678"), "dddddddeeeeeeerlooooooo5678ooooooooooooooom")
